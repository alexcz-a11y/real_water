...
bands, a camera-relative clipmap, a stable three-state waterline, and a
double-sided optical path with water-to-air total internal reflection and a
fixed-size horizontal planar reflection composed over Host environment fallback,
stock r185 non-stochastic current-frame SSR, dedicated specular
