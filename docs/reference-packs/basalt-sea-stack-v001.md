...
|---|---|---|
| `sea-stack-anchor-3q-v001.png` | Identity anchor, three-quarter | `7a85a7db5c9c9337` |
| `sea-stack-elev-front-v001.png` | Front elevation | `0e9b33141900d380` |
| `sea-stack-elev-side-v001.png` | Side elevation | `b558aa4d53415b7e` |
| `sea-stack-elev-back-v001.png` | Back elevation | `ce9eb38e0e21ea30` |
| `sea-stack-mat-column-faces-v001.png` | Material — column faces and joints | `d4e1366a14909299` |
| `sea-stack-mat-waterline-v001.png` | Material — across the waterline stain | `46da75c8d14a648f` |
| `sea-stack-mat-summit-tops-v001.png` | Material — broken column tops from above | `c8fdc5186018ac8d` |
| `sea-stack-lookdev-wet-v001.png` | Wet look-dev | `4196389438730386` |
