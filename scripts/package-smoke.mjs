...
try {
  ...
  const runtimeSmoke = [
    ...
    'if (profile.whitecaps.mode !== "unified-source-ping-pong" || profile.whitecaps.sourceLayout !== "whitecap-wake-impact-combined" || profile.whitecaps.localHistoryBanks !== 2 || profile.whitecaps.maxLocalSources !== 128) throw new Error("Packed Quality Profile unified foam policy drifted.");',
