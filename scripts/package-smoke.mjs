...
try {
  ...
  const runtimeSmoke = [
    ...
    'if (realWater.ENVIRONMENT_PRESET_VERSION !== 2 || realWater.createReferenceEnvironmentPreset().presetHash !== "sha256:ded2112cc607c9d976901fa69b162193402c13d0e8e4d2ad3cd179aa26bd8ad1" || realWater.createStormFrontEnvironmentPreset().presetHash !== "sha256:e7f3fc968e067bff606718e85a388bce545a6896a6b037198f5c43cce885db45") throw new Error("Packed Environment Preset identities drifted.");',
    'if (realWater.SHOWCASE_PRESET_VERSION !== 2 || realWater.createReferenceShowcasePreset().presetHash !== "sha256:63d7b154b4f3803c27507794f7a8d3cfb1d9e85442bc37e2d3eaf0d4c10a8d55") throw new Error("Packed Showcase Preset identity drifted.");',
