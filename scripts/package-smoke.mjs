...
try {
  ...
  const runtimeSmoke = [
    ...
    'if (manifest.declarations.length !== 63) throw new Error("Packed Prewarm Manifest work count drifted.");',
    ...
    'if (!Array.isArray(diagnostics.DIAGNOSTICS_CAPTURE_NAMES) || diagnostics.DIAGNOSTICS_CAPTURE_NAMES.length !== 25) throw new Error("Packed diagnostics capture names drifted.");',
