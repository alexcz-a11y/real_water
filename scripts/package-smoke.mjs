...
try {
  ...
  const runtimeSmoke = [
    ...
    "  realWater.createCalmSunriseEnvironmentPreset(),",
    "  realWater.createBlueNoonEnvironmentPreset(),",
    "  realWater.createReferenceEnvironmentPreset(),",
    "  realWater.createStormFrontEnvironmentPreset(),",
    ...
    'if (JSON.stringify(profile.reflection.ssr.history.resetDomains) !== JSON.stringify(["simulation-reset","camera-cut","origin-shift","sea-state-cut","waterline-crossing"])) throw new Error("Packed Quality Profile reset domains drifted.");',
    ...
    'if (profile.interaction.anchorCount !== 1 || profile.interaction.field.radiusMetres !== 48 || profile.interaction.field.edgeFadeMetres !== 8 || profile.interaction.field.maxActiveDisturbances !== 128 || profile.interaction.field.snapshotBanks !== 2 || profile.interaction.field.maxSnapshotAgeTicks !== 1 || profile.interaction.field.radialImpactRoute !== "analytic-uniform-array" || profile.interaction.field.directionalWakeRoute !== "analytic-uniform-array" || profile.interaction.field.maxActiveHeroBreakers !== 8 || profile.interaction.field.heroBreakerRoute !== "art-directed-overturning-uniform-array") throw new Error("Packed Quality Profile interaction policy drifted.");',
    'if (profile.bodyCoupling.fixedTickHz !== 60 || profile.bodyCoupling.maxAttachedBodies !== 32 || profile.bodyCoupling.maxShapeSamplesPerBody !== 32 || profile.bodyCoupling.maxConvexHullVertices !== 64 || profile.bodyCoupling.maxSocketsPerBody !== 8 || profile.bodyCoupling.socketRoute !== "stable-slot-upsert") throw new Error("Packed Quality Profile Body coupling policy drifted.");',
    'if (realWater.QUALITY_PROFILE_VERSION !== 15 || profile.underwater.mode !== "depth-aware-post-volume" || profile.underwater.composition !== "post-ssr-pre-traa" || profile.underwater.resolutionPolicy !== "drawing-buffer-exact" || profile.underwater.colorFormat !== "rgba16float" || profile.underwater.diagnosticsFormat !== "rgba16float" || profile.underwater.maxDistanceMetres !== 96 || profile.underwater.shadowRoute !== "screen-space-depth-occlusion" || profile.underwater.shaftRoute !== "deterministic-epipolar") throw new Error("Packed Quality Profile underwater policy drifted.");',
    'if (profile.underwater.caustics.mode !== "prepared-surface-visible-receivers" || profile.underwater.caustics.composition !== "post-ssr-pre-traa" || profile.underwater.caustics.resolutionPolicy !== "drawing-buffer-exact" || profile.underwater.caustics.diagnosticsFormat !== "rgba16float" || profile.underwater.caustics.samples !== 0 || profile.underwater.caustics.localSurfaceFieldFormat !== "rgba16float" || profile.underwater.caustics.localSurfaceFieldLayout !== "height-slope-x-slope-z-vertical-velocity" || profile.underwater.caustics.localSurfaceFieldResolutionPolicy !== "match-unified-foam-field" || profile.underwater.caustics.localSurfaceFieldUpdateCadence !== "host-fixed-tick" || profile.underwater.caustics.maxLocalSurfaceSnapshotAgeTicks !== 1 || profile.underwater.caustics.maxReceiverDistanceMetres !== 48 || profile.underwater.caustics.receiverNormalMinY !== 0.05 || profile.underwater.caustics.updateCadence !== "host-present") throw new Error("Packed Quality Profile underwater caustics policy drifted.");',
    'if (profile.underwater.tracers.mode !== "shared-pool-depth-aware" || profile.underwater.tracers.composition !== "pre-traa" || profile.underwater.tracers.resolutionPolicy !== "drawing-buffer-exact" || profile.underwater.tracers.accumulationFormat !== "rgba16float" || profile.underwater.tracers.samples !== 0 || profile.underwater.tracers.depthRoute !== "soft-scene-depth" || profile.underwater.tracers.suspendedConsumerId !== "underwater-suspended-particles" || profile.underwater.tracers.bubbleCloudConsumerId !== "subsurface-foam-bubble-cloud" || profile.underwater.tracers.risingBubbleConsumerId !== "rising-bubbles" || profile.underwater.tracers.updateCadence !== "host-fixed-tick") throw new Error("Packed Quality Profile underwater tracer policy drifted.");',
    'if (profile.whitecaps.mode !== "unified-source-ping-pong" || profile.whitecaps.sourceLayout !== "whitecap-wake-impact-hero-combined" || profile.whitecaps.localHistoryBanks !== 2 || profile.whitecaps.maxLocalSources !== 128 || profile.whitecaps.foamTimelineCapacityTicks !== 128) throw new Error("Packed Quality Profile unified foam policy drifted.");',
    'if (realWater.MAX_SECONDARY_PARTICLES !== 131072 || profile.secondaryParticles.capacity !== 131072 || profile.secondaryParticles.maximumCandidateCount !== 147456 || profile.secondaryParticles.contribution.screenAreaDivisor !== 3600 || profile.secondaryParticles.hysteresis.retainedContributionBonusQ16 !== 4096 || profile.secondaryParticles.hysteresis.minimumResidenceTicks !== 4 || profile.secondaryParticles.hysteresis.reentryCooldownTicks !== 4 || profile.secondaryParticles.consumers.length !== 4 || profile.secondaryParticles.consumers[0]?.consumerId !== "spray-droplet-mist" || profile.secondaryParticles.consumers[0]?.maximumRequestCount !== 65536 || profile.secondaryParticles.consumers[0]?.softRequestCeiling !== 32768 || profile.secondaryParticles.consumers[0]?.minimumRetainedSlots !== 2048 || profile.secondaryParticles.consumers[0]?.pressureReentryPolicy !== "after-shared-cooldown" || profile.secondaryParticles.consumers[1]?.consumerId !== "underwater-suspended-particles" || profile.secondaryParticles.consumers[1]?.maximumRequestCount !== 49152 || profile.secondaryParticles.consumers[1]?.softRequestCeiling !== 24576 || profile.secondaryParticles.consumers[1]?.minimumRetainedSlots !== 2048 || profile.secondaryParticles.consumers[1]?.pressureReentryPolicy !== "after-shared-cooldown" || profile.secondaryParticles.consumers[2]?.consumerId !== "subsurface-foam-bubble-cloud" || profile.secondaryParticles.consumers[2]?.maximumRequestCount !== 24576 || profile.secondaryParticles.consumers[2]?.softRequestCeiling !== 12288 || profile.secondaryParticles.consumers[2]?.minimumRetainedSlots !== 1024 || profile.secondaryParticles.consumers[2]?.pressureReentryPolicy !== "after-shared-cooldown" || profile.secondaryParticles.consumers[3]?.consumerId !== "rising-bubbles" || profile.secondaryParticles.consumers[3]?.maximumRequestCount !== 8192 || profile.secondaryParticles.consumers[3]?.softRequestCeiling !== 4096 || profile.secondaryParticles.consumers[3]?.minimumRetainedSlots !== 256 || profile.secondaryParticles.consumers[3]?.pressureReentryPolicy !== "forbidden-until-absent") throw new Error("Packed shared secondary-particle policy drifted.");',
    'if (profile.stormFront.mode !== "prepared-deterministic-route" || profile.stormFront.updateCadence !== "host-fixed-tick" || profile.stormFront.rain.surfaceRoute !== "additive-spectral-ripples" || profile.stormFront.rain.secondaryParticleConsumerId !== "spray-droplet-mist" || profile.stormFront.rain.maximumCandidateCount !== 8192 || profile.stormFront.stormAerosol.secondaryParticleConsumerId !== "spray-droplet-mist" || profile.stormFront.stormAerosol.maximumCandidateCount !== 8192 || profile.stormFront.cloudAndLightning.illuminationRoute !== "coherent-glint-foam-reflection-atmosphere" || profile.stormFront.cloudAndLightning.atmosphereStageId !== "storm-atmosphere" || profile.stormFront.diagnostics.resolutionPolicy !== "drawing-buffer-exact" || profile.stormFront.diagnostics.format !== "rgba16float" || profile.stormFront.diagnostics.samples !== 0) throw new Error("Packed Storm Front policy drifted.");',
    'if (profile.postTraaComposition.mode !== "ordered-declarative-stages" || profile.postTraaComposition.stages.length !== 3 || profile.postTraaComposition.stages[0]?.id !== "secondary-particles" || profile.postTraaComposition.stages[0]?.after !== "traa" || profile.postTraaComposition.stages[1]?.id !== "storm-atmosphere" || profile.postTraaComposition.stages[1]?.after !== "secondary-particles" || profile.postTraaComposition.stages[2]?.id !== "lens-wetness" || profile.postTraaComposition.stages[2]?.after !== "storm-atmosphere" || profile.postTraaComposition.lensWetness.mode !== "bounded-emergence-decay" || profile.postTraaComposition.lensWetness.trigger !== "waterline-emergence-impulse") throw new Error("Packed post-TRAA composition plan drifted.");',
    'if (realWater.WATER_PRESET_VERSION !== 5) throw new Error("Packed Water Preset version must be 5.");',
    'if (realWater.ENVIRONMENT_PRESET_VERSION !== 2 || realWater.createCalmSunriseEnvironmentPreset().presetHash !== "sha256:6206f0d812c6d9b062034e0920863efb89af195fb35875d4c961b7fa0465b8a2" || realWater.createBlueNoonEnvironmentPreset().presetHash !== "sha256:366f723401eafbc5c087eee97bb6ff6bb264e1c265c04355a82276740ae55dc0" || realWater.createReferenceEnvironmentPreset().presetHash !== "sha256:ded2112cc607c9d976901fa69b162193402c13d0e8e4d2ad3cd179aa26bd8ad1" || realWater.createStormFrontEnvironmentPreset().presetHash !== "sha256:e7f3fc968e067bff606718e85a388bce545a6896a6b037198f5c43cce885db45") throw new Error("Packed Environment Preset identities drifted.");',
    'if (realWater.SHOWCASE_PRESET_VERSION !== 3 || realWater.REFERENCE_SHOWCASE_SEED !== 0x5eed0025 || realWater.createReferenceShowcasePreset().presetHash !== "sha256:ad213eed70ccab18c0c37b80e6fe90c50d3f26bcec4e4e7a0fc21f445a33ca54") throw new Error("Packed Showcase Preset identity drifted.");',
    "const manifest = realWater.createMinimalWaterPrewarmManifest(profile, { width: 320, height: 180 });",
    'if (manifest.declarations.length !== 140) throw new Error("Packed Prewarm Manifest work count drifted.");',
    ...
    'const causticsLocalSurface = manifest.declarations.find((declaration) => declaration.id === "water-underwater-caustics-local-surface-field");',
    "const causticsLocalSurfaceResolution = `${profile.whitecaps.fieldResolution}x${profile.whitecaps.fieldResolution}`;",
    'if (causticsLocalSurface?.kind !== "resource" || !causticsLocalSurface.label.includes(`RGBA16F ${causticsLocalSurfaceResolution} anchor-local current height/slope/velocity`)) throw new Error("Packed manifest is missing the bounded caustics local-surface field.");',
    "const descriptor = realWater.SUPPORTED_HOST_ENVIRONMENT_REFLECTION;",
    'if (realWater.PREWARM_MANIFEST_VERSION !== 12) throw new Error("Packed Prewarm Manifest version must be 12.");',
    'if (manifest.version !== 12) throw new Error("Packed manifest version must be 12.");',
    'if (!manifest.effectVariants.some((variant) => variant.effectId === "hero-breaker" && variant.variantId === "art-directed-overturning")) throw new Error("Packed manifest omitted the Hero Breaker effect variant.");',
    'for (const effectId of ["rain", "storm-aerosol", "cloud-shadow", "lightning"]) if (!manifest.effectVariants.some((variant) => variant.effectId === effectId)) throw new Error("Packed manifest omitted Storm Front effect variant " + effectId + ".");',
    ...
    'if (lease.inspectRuntime().seaLevelMetres !== 0) throw new Error("Packed Host sea level drifted.");',
    ...
    'if (realWater.MAX_ACTIVE_DISTURBANCES !== 128 || realWater.MAX_ACTIVE_HERO_BREAKERS !== 8 || lease.capabilities.gameplay.maxActiveDisturbances !== 128 || lease.capabilities.gameplay.maxActiveHeroBreakers !== 8 || lease.capabilities.gameplay.interactionField.radiusMetres !== 48 || lease.capabilities.gameplay.interactionField.edgeFadeMetres !== 8 || lease.capabilities.gameplay.interactionField.maxSnapshotAgeTicks !== 1 || JSON.stringify(lease.capabilities.gameplay.interactionField.disturbanceKinds) !== JSON.stringify(["radial-impact","directional-wake","hero-breaker"])) throw new Error("Packed local interaction capabilities drifted.");',
    'if (lease.capabilities.gameplay.bodyInteraction.fixedTickHz !== 60 || lease.capabilities.gameplay.bodyInteraction.maxShapeSamplesPerBody !== 32 || lease.capabilities.gameplay.bodyInteraction.maxConvexHullVertices !== 64 || lease.capabilities.gameplay.bodyInteraction.maxSocketsPerBody !== 8) throw new Error("Packed Body interaction capabilities drifted.");',
    ...
    "const secondaryParticles = lease.capabilities.rendering.secondaryParticles;",
    'if (secondaryParticles.capacity !== 131072 || secondaryParticles.maximumCandidateCount !== 147456 || secondaryParticles.contributionReference.width !== 320 || secondaryParticles.contributionReference.height !== 180 || secondaryParticles.contributionReference.space !== "output-drawing-buffer" || secondaryParticles.contributionReference.screenAreaDivisor !== 3600 || secondaryParticles.hysteresis.retainedContributionBonusQ16 !== 4096 || secondaryParticles.consumers.length !== 4 || secondaryParticles.consumers[0]?.pressureReentryPolicy !== "after-shared-cooldown" || secondaryParticles.consumers[1]?.consumerId !== "underwater-suspended-particles" || secondaryParticles.consumers[1]?.pressureReentryPolicy !== "after-shared-cooldown" || secondaryParticles.consumers[2]?.consumerId !== "subsurface-foam-bubble-cloud" || secondaryParticles.consumers[2]?.pressureReentryPolicy !== "after-shared-cooldown" || secondaryParticles.consumers[3]?.consumerId !== "rising-bubbles" || secondaryParticles.consumers[3]?.pressureReentryPolicy !== "forbidden-until-absent") throw new Error("Packed ready secondary-particle capabilities drifted.");',
    "const postTraa = lease.capabilities.rendering.postTraaComposition;",
    'if (postTraa.width !== 320 || postTraa.height !== 180 || postTraa.stages[0]?.id !== "secondary-particles" || postTraa.stages[0]?.after !== "traa") throw new Error("Packed ready post-TRAA capabilities drifted.");',
    ...
    'const wakeReceipt = lease.submitDisturbances({ kind: "directional-wake", count: 1, ids: Uint32Array.of(25), positions: Float32Array.of(0, 0, 0), directions: Float32Array.of(0, 0, 1), radii: Float32Array.of(2), amplitudes: Float32Array.of(0.25), priorities: Uint8Array.of(1) });',
    'if (wakeReceipt.acceptedDisturbanceIds[0] !== 25 || wakeReceipt.activeDisturbanceCount !== 2) throw new Error("Packed directional-wake Disturbance failed.");',
    ...
    'if (!Array.isArray(diagnostics.DIAGNOSTICS_CAPTURE_NAMES) || diagnostics.DIAGNOSTICS_CAPTURE_NAMES.length !== 45) throw new Error("Packed diagnostics capture names drifted.");',
    'if (!diagnostics.DIAGNOSTICS_CAPTURE_NAMES.includes("underwater-transmittance") || !diagnostics.DIAGNOSTICS_CAPTURE_NAMES.includes("underwater-scattering") || !diagnostics.DIAGNOSTICS_CAPTURE_NAMES.includes("underwater-light-shafts") || !diagnostics.DIAGNOSTICS_CAPTURE_NAMES.includes("underwater-shadow") || diagnostics.DIAGNOSTICS_CAPTURE_SHAPES["underwater-shadow"].format !== "r32float-underwater-volume") throw new Error("Packed diagnostics omitted underwater volume captures.");',
    'if (!diagnostics.DIAGNOSTICS_CAPTURE_NAMES.includes("underwater-caustics") || diagnostics.DIAGNOSTICS_CAPTURE_SHAPES["underwater-caustics"].format !== "r32float-underwater-caustics" || diagnostics.DIAGNOSTICS_CAPTURE_SHAPES["underwater-caustics"].components !== 1) throw new Error("Packed diagnostics omitted the independent underwater caustics capture.");',
    'if (diagnostics.DIAGNOSTICS_CAPTURE_SHAPES["underwater-particles"].format !== "r32float-underwater-particles" || diagnostics.DIAGNOSTICS_CAPTURE_SHAPES["underwater-bubbles"].format !== "r32float-underwater-bubbles" || diagnostics.DIAGNOSTICS_CAPTURE_SHAPES["lens-wetness"].format !== "r32float-lens-wetness") throw new Error("Packed diagnostics omitted T22 particle, bubble, or wetness captures.");',
    'if (!diagnostics.DIAGNOSTICS_CAPTURE_NAMES.includes("foam-source-identity")) throw new Error("Packed diagnostics omitted the unified foam source identity capture.");',
    'if (!diagnostics.DIAGNOSTICS_CAPTURE_NAMES.includes("secondary-particle-contribution") || !diagnostics.DIAGNOSTICS_CAPTURE_NAMES.includes("secondary-particle-overdraw") || diagnostics.DIAGNOSTICS_CAPTURE_SHAPES["secondary-particle-contribution"].format !== "r32float-secondary-particle-contribution" || diagnostics.DIAGNOSTICS_CAPTURE_SHAPES["secondary-particle-overdraw"].format !== "r32float-secondary-particle-overdraw") throw new Error("Packed diagnostics omitted secondary-particle outputs.");',
    'if (!diagnostics.DIAGNOSTICS_CAPTURE_NAMES.includes("hero-breaker-foam") || diagnostics.DIAGNOSTICS_CAPTURE_SHAPES["hero-breaker-foam"].format !== "r32float-hero-breaker-foam" || diagnostics.DIAGNOSTICS_CAPTURE_SHAPES["hero-breaker-foam"].components !== 1) throw new Error("Packed diagnostics omitted Hero Breaker foam.");',
    'for (const name of ["storm-rain-ripples", "storm-aerosol", "storm-cloud-shadow", "storm-lightning"]) if (!diagnostics.DIAGNOSTICS_CAPTURE_NAMES.includes(name) || diagnostics.DIAGNOSTICS_CAPTURE_SHAPES[name].format !== "r32float-storm-front" || diagnostics.DIAGNOSTICS_CAPTURE_SHAPES[name].components !== 1) throw new Error("Packed diagnostics omitted Storm Front capture " + name + ".");',
    'if (!diagnostics.DIAGNOSTICS_CAPTURE_NAMES.includes("waterline") || !diagnostics.DIAGNOSTICS_CAPTURE_NAMES.includes("history-rejection")) throw new Error("Packed diagnostics omitted waterline captures.");',
    'if (diagnostics.DIAGNOSTICS_CAPTURE_SHAPES.waterline.format !== "r32float-waterline-coverage" || diagnostics.DIAGNOSTICS_CAPTURE_SHAPES["history-rejection"].format !== "r32float-history-rejection") throw new Error("Packed waterline capture shapes drifted.");',
    ...
    'if (!diagnostics.DIAGNOSTICS_CAPTURE_NAMES.includes("foam-source-identity") || diagnostics.DIAGNOSTICS_CAPTURE_SHAPES["foam-source-identity"].format !== "rgba32float-foam-source-identity" || diagnostics.DIAGNOSTICS_CAPTURE_SHAPES["foam-source-identity"].components !== 4) throw new Error("Packed diagnostics omitted unified foam source identity.");',
